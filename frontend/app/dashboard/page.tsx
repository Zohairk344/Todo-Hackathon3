...
export default function DashboardPage() {
  ...
  const [returnToTaskModal, setReturnToTaskModal] = useState(false);



  const handleAddCategoryFromTask = () => {

    setIsTaskModalOpen(false);

    setReturnToTaskModal(true);
  ...
  const handleCategoryModalClose = () => {
    ...
    if (returnToTaskModal) {

      setReturnToTaskModal(false);
  ...
  return (
    ...
    <div className="flex-1 space-y-4 p-8 pt-6">
      ...
      <NewTaskDialog 
        ...
        onAddCategory={handleAddCategoryFromTask}
